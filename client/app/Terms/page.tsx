  ...
  return (
    <div className="py-12 mx-5 my-10  md:mx-10 lg:mx-40  ">
      <div className='py-10'>
        ...
        <h1 className='text-5xl font-bold text-center'>Terms & Condition</h1>
      </div>
      <div>

        <h2 className='text-3xl  '>Payment Policy</h2>
        <p className='py-5 text-gray-500'>
          All services provided by Walkers Tours Limited (WTL) are subject to the following terms and conditions “Services” refers to any one or more of the following; (a) Transport (b) Accommodation (c) Other tourist services.
        </p>
